...
Route::middleware([AdminAuth::class, GuardRequest::class])->prefix(config('form-tool.adminURL'))->name('')->group(function () {
    ...
    Route::get('activities-log/show/{id}', [\App\Http\Controllers\Admin\ActionsLogController::class, 'show'])->name('activities-log.show');
    Route::get('activities-log', [\App\Http\Controllers\Admin\ActionsLogController::class, 'index'])->name('activities-log');
